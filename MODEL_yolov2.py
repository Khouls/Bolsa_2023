...
def yolov2(IMAGE_H, IMAGE_W, BOXES_CELL, NUM_CLASSES):
	...
	# Layer 23 (OUTPUT -> Number of boxes in grid cell * (x1,y1,x2,y2, conf. score, class0 prob., class1 prob., ..., classn prob.)
